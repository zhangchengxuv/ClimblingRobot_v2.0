...
bool yesense_interface__msg__quat__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yesense_interface.msg._quat.Quat", full_classname_dest, 32) == 0);
  }
  yesense_interface__msg__Quat * ros_message = _ros_message;
  {  // q0
...
PyObject * yesense_interface__msg__quat__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("yesense_interface.msg._quat");
