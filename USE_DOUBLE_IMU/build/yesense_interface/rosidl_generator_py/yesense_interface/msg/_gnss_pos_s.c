...
bool yesense_interface__msg__gnss_pos__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yesense_interface.msg._gnss_pos.GnssPos", full_classname_dest, 39) == 0);
  }
  yesense_interface__msg__GnssPos * ros_message = _ros_message;
  {  // longitude
...
{
  /* NOTE(esteve): Call constructor of GnssPos */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("yesense_interface.msg._gnss_pos");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GnssPos");
