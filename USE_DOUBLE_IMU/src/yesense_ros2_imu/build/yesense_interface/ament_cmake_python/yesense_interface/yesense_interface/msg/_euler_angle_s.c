...
bool yesense_interface__msg__euler_angle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yesense_interface.msg._euler_angle.EulerAngle", full_classname_dest, 45) == 0);
  }
  yesense_interface__msg__EulerAngle * ros_message = _ros_message;
  {  // pitch
...
{
  /* NOTE(esteve): Call constructor of EulerAngle */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("yesense_interface.msg._euler_angle");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EulerAngle");
