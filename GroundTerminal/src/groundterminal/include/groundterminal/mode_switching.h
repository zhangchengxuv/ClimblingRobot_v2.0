...
// mode 02 模式
void mode_02(float pitch, float roll, float distance, float weight);
// mode 03 模式
void mode_03(float pitch, float roll, float distance, float weight);
// mode 04 模式
void mode_04(float pitch, float roll, float distance, float weight);
