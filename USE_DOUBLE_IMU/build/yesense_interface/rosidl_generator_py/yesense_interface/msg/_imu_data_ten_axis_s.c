...
bool yesense_interface__msg__imu_data_ten_axis__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yesense_interface.msg._imu_data_ten_axis.ImuDataTenAxis", full_classname_dest, 55) == 0);
  }
  yesense_interface__msg__ImuDataTenAxis * ros_message = _ros_message;
  {  // imu_basic
...
{
  /* NOTE(esteve): Call constructor of ImuDataTenAxis */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("yesense_interface.msg._imu_data_ten_axis");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ImuDataTenAxis");
