...
bool yesense_interface__msg__utc__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yesense_interface.msg._utc.Utc", full_classname_dest, 30) == 0);
  }
  yesense_interface__msg__Utc * ros_message = _ros_message;
  {  // year
  ...
  {  // ms
    ...
    assert(PyLong_Check(field));
    ros_message->ms = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of Utc */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("yesense_interface.msg._utc");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Utc");
