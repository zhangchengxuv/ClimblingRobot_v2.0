...
bool yesense_interface__msg__euler_only__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yesense_interface.msg._euler_only.EulerOnly", full_classname_dest, 43) == 0);
  }
  yesense_interface__msg__EulerOnly * ros_message = _ros_message;
  {  // tid
...
{
  /* NOTE(esteve): Call constructor of EulerOnly */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("yesense_interface.msg._euler_only");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "EulerOnly");
