...
bool yesense_interface__msg__sensor_temp__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yesense_interface.msg._sensor_temp.SensorTemp", full_classname_dest, 45) == 0);
  }
  yesense_interface__msg__SensorTemp * ros_message = _ros_message;
  {  // temp
...
{
  /* NOTE(esteve): Call constructor of SensorTemp */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("yesense_interface.msg._sensor_temp");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SensorTemp");
