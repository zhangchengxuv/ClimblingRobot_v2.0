...
bool yesense_interface__msg__tid__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yesense_interface.msg._tid.Tid", full_classname_dest, 30) == 0);
  }
  yesense_interface__msg__Tid * ros_message = _ros_message;
  {  // tid
    ...
    ros_message->tid = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of Tid */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("yesense_interface.msg._tid");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Tid");
