...
bool yesense_interface__msg__pos_only__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yesense_interface.msg._pos_only.PosOnly", full_classname_dest, 39) == 0);
  }
  yesense_interface__msg__PosOnly * ros_message = _ros_message;
  {  // tid
...
{
  /* NOTE(esteve): Call constructor of PosOnly */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("yesense_interface.msg._pos_only");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PosOnly");
